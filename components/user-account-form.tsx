...
interface UserAccountFormProps {
  form: UseFormReturn<z.infer<typeof userAccountSchema>>;
  onSubmit: (values: z.infer<typeof userAccountSchema>) => void;
  isPending: boolean;
  pendudukList?: string[];
}
        ...
        <div className='grid gap-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Silahkan masukkan data penduduk</CardDescription>
            </CardHeader>
            <CardContent className='grid gap-4'>
              ...
              <div className='grid grid-cols-2 gap-3'>
                <FormFieldInput<typeof userAccountSchema>
                  form={form}
                  name='nik'
                  label='NIK'
